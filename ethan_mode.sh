...
JETFIT_PATH="/skynet/ampy/VegasDev/VegasJetFit/jetfit/run.py"
LOG_DIR="/skynet/ampy/VegasDev/VegasJetFit/logs"
...
taskset -c 0-32 nohup python $JETFIT_PATH --event "$event1" --obs "/skynet/ampy/VegasDev/VegasJetFit/jetfit/resources/grbs/221009A/221009Aclean.csv" --results "/skynet/ampy/VegasDev/VegasJetFit/jetfit/results/2210test" > "$log_file1" 2>&1 &
