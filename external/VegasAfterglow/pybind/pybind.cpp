...
PYBIND11_MODULE(VegasAfterglowC, m) {
    ...
    auto sbpl_type [[maybe_unused]] = py::class_<SmoothBrokenPowerLaw>(m, "_SmoothBrokenPowerLaw");
    ...
    m.def("SmoothBrokenPowerLawMedium",
          [](Real n_t, Real r_t, Real k1, Real k2, Real s_n, Real X_h) -> MediumVariant {
              return PySmoothBrokenPowerLaw(n_t, r_t, k1, k2, s_n, X_h);
          },
          py::arg("n_t"), py::arg("r_t"), py::arg("k1"), py::arg("k2"), py::arg("s_n"), py::arg("X_h") = 0.7);
    ...
    py::class_<PyRadiation>(m, "Radiation")
        .def(py::init<Real, Real, Real, Real, bool, bool, bool, bool>(), py::arg("eps_e"), py::arg("eps_B"),
             py::arg("p"), py::arg("xi_e") = 1, py::arg("ssc") = false, py::arg("kn") = false,
             py::arg("cmb_cooling") = false, py::arg("smooth_fast_to_slow_transition") = false)
        ...
        .def_property_readonly("smooth_fast_to_slow_transition",
                               [](PyRadiation const& r) { return r.rad.smooth_fast_to_slow_transition; })
    ...
    py::class_<PyModel>(m, "Model")
        .def(py::init([](py::object jet_obj, py::object medium_obj, PyObserver observer, PyRadiation fwd_rad,
                 ...
                 auto medium = [&]() -> MediumVariant {
                     ...
                     if (py::isinstance<SmoothBrokenPowerLaw>(medium_obj)) {
                         return medium_obj.cast<SmoothBrokenPowerLaw>();
                     }
                     if (py::isinstance<Medium>(medium_obj)) {
                         return medium_obj.cast<Medium>();
                     }
                     throw py::type_error("medium must be ISM, Wind, SmoothBrokenPowerLaw, or Medium");
                 }();
