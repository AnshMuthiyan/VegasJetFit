...
template <typename Electrons, typename Photons, typename Updater>
void IC_cooling(ElectronGrid<Electrons>& electrons, PhotonGrid<Photons>& photons, Shock const& shock,
                Coord const& coord, MediumVariant const& medium, bool smooth_fast_to_slow_transition,
                Updater&& update_gamma_c, Real redshift = 0.0) {
    const size_t phi_size = electrons.shape()[0];
    const size_t t_size = electrons.shape()[2];
    ...
    broadcast_symmetry(electrons, coord);
    generate_syn_photons(photons, shock, electrons, coord, medium, smooth_fast_to_slow_transition);
}
...
void Thomson_cooling(ElectronGrid<Electrons>& electrons, PhotonGrid<Photons>& photons, Shock const& shock,
    ...
    IC_cooling(electrons, photons, shock, coord, medium, false, update_gamma_c_Thomson, redshift);
}
...
void Thomson_cooling(ElectronGrid<Electrons>& electrons, PhotonGrid<Photons>& photons, Shock const& shock,
                     Coord const& coord, MediumVariant const& medium, bool smooth_fast_to_slow_transition,
                     Real redshift) {
    IC_cooling(electrons, photons, shock, coord, medium, smooth_fast_to_slow_transition, update_gamma_c_Thomson,
               redshift);
}
...
void KN_cooling(ElectronGrid<Electrons>& electrons, PhotonGrid<Photons>& photons, Shock const& shock,
                Coord const& coord, MediumVariant const& medium, Real redshift) {
    IC_cooling(electrons, photons, shock, coord, medium, false, update_gamma_c_KN, redshift);
}

template <typename Electrons, typename Photons>
void KN_cooling(ElectronGrid<Electrons>& electrons, PhotonGrid<Photons>& photons, Shock const& shock,
                Coord const& coord, MediumVariant const& medium, bool smooth_fast_to_slow_transition, Real redshift) {
    IC_cooling(electrons, photons, shock, coord, medium, smooth_fast_to_slow_transition, update_gamma_c_KN,
               redshift);
}
...
void CMB_cooling(ElectronGrid<Electrons>& electrons, PhotonGrid<Photons>& photons, Shock const& shock,
                 Coord const& coord, MediumVariant const& medium, Real redshift) {
    IC_cooling(electrons, photons, shock, coord, medium, false, update_gamma_c_CMB, redshift);
}

template <typename Electrons, typename Photons>
void CMB_cooling(ElectronGrid<Electrons>& electrons, PhotonGrid<Photons>& photons, Shock const& shock,
                 Coord const& coord, MediumVariant const& medium, bool smooth_fast_to_slow_transition, Real redshift) {
    IC_cooling(electrons, photons, shock, coord, medium, smooth_fast_to_slow_transition, update_gamma_c_CMB,
               redshift);
}
