...
class EmpiricalBubbleVegasDylanSpectrumModel(EmpiricalBubbleVegasModel):
    """
    Empirical-bubble VegasAfterglow adapter with Dylan/GS02 spectral smoothing.

    The blast-wave dynamics come from VegasAfterglow with the empirical bubble
    medium, while the emitted spectrum uses JetFit's analytic break smoothing.
    """
