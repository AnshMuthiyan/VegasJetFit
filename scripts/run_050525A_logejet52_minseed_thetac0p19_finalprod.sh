...
export CONFIG_DIR="${CONFIG_DIR:-$VEGAS_DIR/structured_jet_logejet52_050525A_minseed_thetac0p19_configs_active}"
export RUN_TAG="${RUN_TAG:-structjet_logejet52_minseed_thetac0p19_finalprod_10temp_5000x5000_v1}"
...
# Keep the standard guarded preflight, then run MCMC only on remote machines.
