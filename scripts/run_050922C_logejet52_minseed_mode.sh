...
MODE_FAMILY="${MODE_FAMILY:?set MODE_FAMILY to narrow_tc0p132, mid_tc0p171, or wide_tc0p219}"

export EVENT="${EVENT:-050922C}"
export CONFIG_DIR="${CONFIG_DIR:-$VEGAS_DIR/structured_jet_logejet52_050922C_minseed_mode_configs_active/$MODE_FAMILY}"
