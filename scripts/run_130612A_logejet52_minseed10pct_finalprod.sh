...
export CONFIG_DIR="${CONFIG_DIR:-$VEGAS_DIR/structured_jet_logejet52_130612A_minseed10pct_configs_active}"
...
# Guard with a one-step preflight, then run MCMC only on worker hosts.
