...
MODE_FAMILY="${MODE_FAMILY:?set MODE_FAMILY to wide_offaxis_highdensity, nearaxis_lowdensity_inverted, or verywide_ultrahighdensity}"

export EVENT="${EVENT:-140506A}"
export CONFIG_DIR="${CONFIG_DIR:-$VEGAS_DIR/structured_jet_logejet52_140506A_minseed_mode_configs_active/$MODE_FAMILY}"
