...
export EVENT="${EVENT:-220101A}"
export CONFIG_DIR="${CONFIG_DIR:-$VEGAS_DIR/structured_jet_logejet52_220101A_dylan_data_minseed10pct_final_configs_active}"
export OBS_CSV_OVERRIDE="${OBS_CSV_OVERRIDE:-$VEGAS_DIR/jetfit/results/220101A_structjet_logejet52_dylan_data_penultimate_10temp_5000x5000_v1/obs.csv}"
export RUN_TAG="${RUN_TAG:-structjet_logejet52_dylan_data_minseed10pct_finalprod_10temp_5000x5000_v1}"
